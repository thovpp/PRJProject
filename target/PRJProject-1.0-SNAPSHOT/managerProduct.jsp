        ...
        <%
            ...
            if (session.getAttribute("quantri") == null) {
                ...
                if (cook != null) {
                    ...
                    if (ac != null) {
                        if (ac.getIsAdmin() == 1 || ac.getIsSell() == 1) {
            ...
            Account add = (Account) session.getAttribute("quantri");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <c:if test="${sessionScope.quantri.isAdmin  == 1}">
                                            <a onclick="return confirm('Để tránh trường hợp xóa sản phẩm đã được đặt hàng trước đây khi xóa chúng tôi chỉ update trạng thái sản phẩm lại là Ngừng bán')" href="/PRJProject/manager/Delete/${o.product_id}" class="delete" data-toggle="modal">
