        ...
        <div class="container">
            <div class="row justify-content-around">
                <form
                    ...
                    >
                    <h2 class="text-center text-uppercase py-3">Add Supplier</h2>
                    <div class="mb-3">
                        <label for="sup_name">Ten: </label>
                        <input type="text" required class="form-control"  name="sup_name" id="pro_name" />
                    </div>
                    <div class="mb-3">
                        <label for="pro_quan">Dia Chi: </label>
                        <input type="text" name="sup_address"  class="form-control" id="pro_color" />
                    </div>
                    <div class="mb-3">
                        <label for="pro_price">Phone Number: </label>
                        <input type="number" name="sup_phone"  class="form-control" id="pro_price" />
                    </div>
                    <div class="mb-3">
                        <label for="pro_quan">Email:  </label>
                        <input type="email" required name="sup_email"  class="form-control" id="pro_quan" />
                    </div>
                    <input
                        type="submit"
                        value="AddSupplier"
