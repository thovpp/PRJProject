                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="border-0 bg-light">
                                            <div class="py-2 text-uppercase">TỔNG SẢN PHẨM</div>
                                        </th>
                                        <th scope="col" class="border-0 bg-light">
                                ...
                                <tbody>
                                    <c:forEach items="${listTails}" var="o" varStatus="status">
                                        <tr >
                                            <td class="align-middle"><img src="${infoProduct[status.index].product_pic}" alt="" width="100" class="img-fluid rounded shadow-sm"></td>
