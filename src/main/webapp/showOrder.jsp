                            ...
                            <c:forEach items="${listOr}" var="o">
                                ...
                                <tr >
                                    ...
                                    <td class="align-middle"> <nav class="navbar navbar-expand-lg bg-light justify-content-center ">
                                            <ul class="navbar-nav">
                                                <li class="nav-item"><a class="nav-link" href="/PRJProject/manager/ShowOrder/EditStatus/${o.order_id}"><i class='bx bx-message-square-edit'></i></a></li> 
                                            </ul>
                                            <ul class="navbar-nav">
                                                <li class="nav-item"><a class="nav-link" href="/PRJProject/manager/ShowOrder/Details/${o.order_id}"><i class='bx bx-info-circle'></i></a></li> 
                                            </ul>
